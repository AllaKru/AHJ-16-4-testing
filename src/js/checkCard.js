export default function checkCard(value) {
  ...
  if (/(^(4026|4508|4844|4913|4917)[0-9]{12}|^417500{10})/.test(value)) {
    ...
    /(^(5018|5020|5038|5893|6304|6759|6761|6762|6763)[0-9]{12}|^(5018|5020|5038|5893|6304|6759|6761|6762|6763)[0-9]{15})/.test(
      value,
    )
  ) {
    document.querySelector('.maestro').classList.add('active');
    return 'maestro';
  } if (/(^6011[0-9]{12}|^6011[0-9]{15})/.test(value)) {
    document.querySelector('.discover').classList.add('active');
    return 'discover';
  } if (/^([51-55][0-9]{14}|^[222100-272099]{10})/.test(value)) {
    document.querySelector('.mastercard').classList.add('active');
    return 'mastercard';
  } if (/(^[300-305][0-9]{11}|^36[0-9]{12}|^54[0-9]{14})/.test(value)) {
    ...
    return 'amex';
  } if (/(^[352-358][0-9]{16}|^[352-358][0-9]{13})/.test(value)) {
    document.querySelector('.jcb').classList.add('active');
    return 'jcb';
  } if (/^(637|638|639)[0-9]{13}/.test(value)) {
